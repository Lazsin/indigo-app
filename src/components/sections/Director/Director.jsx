...
export default function Director() {
  return (
    <section className="director text-center p-5 max-w-7xl">
      {/* Заголовок */}
      ...
      {/* Основной контент */}
      <div className="content-d flex flex-col md:flex-row justify-between bg-white rounded-3xl p-4 md:p-8 gap-6">
        {/* Текст */}
        <div className="content-text text-left flex-1 space-y-4">
          <h1 className="name text-purple-700 text-2xl font-bold">Karolina Lubenets</h1>
        ...
        {/* Изображение */}
        <div className="content-img flex-1 max-w-[650px] flex justify-center items-center">
